...
MODELS = [
    ...
    'edpo_msmarco_8b_instruct_joint',
    'edpo_msmarco_8b_instruct_gen',
    '8b_contrast',
    'edpo_msmarco_1.5b_instruct',
    'edpo_msmarco_1.5b_instruct_gen',
]
...
#     print(dataset, tasks[0].metadata.eval_langs)
